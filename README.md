...
**Status: Parts 1–3 complete and submitted.** `main.c` is at version 3.0.

## What it does (as of Part 3)
...
Part 1/, Part 2/, Part 3/   ← that week's spec PDF + submitted main.c snapshot + test evidence
